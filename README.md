...
*   **`utils.py`**: Основные утилиты для загрузки транзакций и конвертации валют.
*   **`data_reader.py`**: Новый модуль для чтения транзакций из CSV и Excel-файлов.
*   **`generators.py`**: Генераторы для обработки транзакций.
*   **`external_api.py`**: Взаимодействие с внешним API для конвертации валют.
**Запуск тестов:**
