...
def log(filename=None):
    """
    Декоратор для логирования вызовов функций, их
    результатов и возникающих исключений.

    Args:
        filename (str, optional): Имя файла для
        записи логов. Если не указано, логи
        выводятся в консоль.

    Returns:
        callable: Декоратор, который оборачивает
        функцию и добавляет логирование.
    """
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            Raises:
                Exception: Если в функции происходит исключение,
                 оно логируется и перевыбрасывается.
            """
